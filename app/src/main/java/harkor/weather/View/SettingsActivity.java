...
public class SettingsActivity extends AppCompatActivity implements FavouritesListAdapter.ItemClickListener, SettingsViewModelInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView favouritesList=findViewById(R.id.favourites_list);
        ImageView backButton=findViewById(R.id.image_arrow_back);
        addFromMap=findViewById(R.id.add_from_map_btn);
        RadioGroup radioGroup=findViewById(R.id.temperature_unit_group);
        ImageView addCityButton=findViewById(R.id.add_favourites_button);
